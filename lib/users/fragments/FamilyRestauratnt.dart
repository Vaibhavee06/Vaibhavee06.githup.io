...
class FamilyRestauratnt extends StatefulWidget {
  const FamilyRestauratnt({super.key});

  @override
  State<FamilyRestauratnt> createState() => _FamilyRestauratntState();
}

class _FamilyRestauratntState extends State<FamilyRestauratnt> {
  double price = 399;
  int qty = 1;
  bool isFav = false;
  @override
